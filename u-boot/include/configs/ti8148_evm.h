...
#  define CONFIG_EXTRA_ENV_SETTINGS \
	"verify=yes\0" \
	"bootcmd=nand read 0x81000000 0x100000 0x40000; go 0x81000000\0" \
...
# define CONFIG_BOOTDELAY		2	/* set to negative value for no autoboot */
...
#  define MNAND_ENV_OFFSET		0x200000	/* environment starts here ,orignal val:0x260000 */
