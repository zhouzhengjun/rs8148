                                  ...
                                  UInt32 prevLinkQueId)
{
    ...
    avsyncPrm->displayID        = Vdis_getDisplayContextIndex(VDIS_DEV_SD);
...
Void multich_cardvr_configure_extvideodecoder_prm(UInt32 numCaptureDevices)
{
    ...
    for(i = 0; i < numCaptureDevices; i++)
    {
        ...
        {
            gCarDVRUsecaseContext.vidDecVideoModeArgs[i].standard           = SYSTEM_STD_MUX_4CH_CIF;
        }
...
Void multich_cardvr_set_link_ids()
{
    ...
    gVcapModuleContext.deiId[CIF_DEI_LINK_IDX]     = SYSTEM_LINK_ID_DEI_0;
...
Void multich_cardvr_reset_link_prms()
{
    ...
    MULTICH_INIT_STRUCT(NsfLink_CreateParams, gCarDVRUsecaseContext.nsfPrm);
...
Void multich_cardvr_set_capture_prm(CaptureLink_CreateParams *capturePrm)
{
    ...
    pCaptureInstPrm->videoDecoderId     = SYSTEM_DEVICE_VID_DEC_TVP5158_DRV;
    pCaptureInstPrm->inDataFormat       = SYSTEM_DF_YUV422P;
    pCaptureInstPrm->standard           = SYSTEM_STD_MUX_4CH_CIF;
    pCaptureInstPrm->numOutput          = 1;
...
static
Void multich_cardvr_set_swms_prm(SwMsLink_CreateParams *swMsPrm)
{
...
Void multich_cardvr_connect_links()
{
    ...
    gCarDVRUsecaseContext.deiPrm[CIF_DEI_LINK_IDX].outQueParams[DEI_LINK_OUT_QUE_DEI_SC].nextLink            = gVdisModuleContext.swMsId[0];
    gCarDVRUsecaseContext.swMsPrm[0].inQueParams.prevLinkId = gVcapModuleContext.deiId[CIF_DEI_LINK_IDX];
    gCarDVRUsecaseContext.swMsPrm[0].inQueParams.prevLinkQueId = DEI_LINK_OUT_QUE_DEI_SC;
    ...
    multich_cardvr_set_swms_prm(&gCarDVRUsecaseContext.swMsPrm[0]);
    gCarDVRUsecaseContext.swMsPrm[0].outQueParams.nextLink     = gVcapModuleContext.nsfId[0];
    gCarDVRUsecaseContext.nsfPrm.inQueParams.prevLinkId = gVdisModuleContext.swMsId[0];
    gCarDVRUsecaseContext.nsfPrm.inQueParams.prevLinkQueId =0;
    ...
    multich_cardvr_set_nsf_prm(&gCarDVRUsecaseContext.nsfPrm);
    gCarDVRUsecaseContext.nsfPrm.outQueParams[0].nextLink  = gCarDVRUsecaseContext.mergeId[D1_CIFCOMPOSITE_MERGE_LINK_IDX];
    ...
    MULTICH_CARDVR_CREATE_LINK(gVcapModuleContext.nsfId[0] , &gCarDVRUsecaseContext.nsfPrm, sizeof(gCarDVRUsecaseContext.nsfPrm));
