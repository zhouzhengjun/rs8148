...
Void MultiCh_createProgressive8D1VcapVencVdecVdis()
{
    ...
    {
        #ifdef ENABLE_SIMCOP_ALGS
        mergePrm[D1_CIF_MERGE_LINK_IDX].outQueParams.nextLink  = gVcapModuleContext.dspAlgId[0];
        ...
        dspAlgPrm.inQueParams.prevLinkId                         = mergeId[D1_CIF_MERGE_LINK_IDX];
        dspAlgPrm.inQueParams.prevLinkQueId                      = 0;
        dspAlgPrm.outQueParams[ALG_LINK_FRAMES_OUT_QUE].nextLink = ipcOutVpssId;
        #else
