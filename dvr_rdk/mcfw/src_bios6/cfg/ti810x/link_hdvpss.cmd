...
/*
  ...
  .text_algLink {
    -ldvr_rdk_bios6.aem3<algLink_tsk.oem3>(.text)
    -ldvr_rdk_bios6.aem3<algLink_priv.oem3>(.text)
    -ldvr_rdk_bios6.aem3<osdLink_alg.oem3>(.text)
    -ldvr_rdk_bios6.aem3<scdLink_alg.oem3>(.text)
