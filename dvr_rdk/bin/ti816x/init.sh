...
rmmod ./kermod/ti81xxhdmi.ko 2> /dev/null
...
#./bin/sys_pri.out --L3-bw-reg-set HDVICP1 1 0 2000 4000
#./bin/sys_pri.out --L3-bw-reg-set HDVICP2 1 0 2000 4000
./bin/sys_pri.out --dmm-pri-set DUCATI 0
./bin/sys_pri.out --dmm-pri-set HDVICP0 2
./bin/sys_pri.out --dmm-pri-set HDVICP1 2
./bin/sys_pri.out --dmm-pri-set HDVICP2 2
