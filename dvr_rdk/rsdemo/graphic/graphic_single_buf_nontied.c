...
int grpx_fb_draw_singleBufNonTied(VDIS_DEV devId, int planeWidth)
{
...
Int32 grpx_fb_start_singleBufNonTied()
{
    ...
    Bell_GetSize(Vdis_getResolution(VDIS_DEV_HDMI), &outWidth,  &outHeight);
	...
	grpx_fb_draw_singleBufNonTied(VDIS_DEV_HDMI, GRPX_PLANE_WIDTH);
