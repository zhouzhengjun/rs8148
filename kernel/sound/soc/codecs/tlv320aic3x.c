...
#define MIC2LR_2_LADC_CTRL              17
#define MIC2LR_2_RADC_CTRL              18
#define MIC2L_2_LADC_CTRL               17
#define MIC2L_2_RADC_CTRL               18
#define MIC2R_2_LADC_CTRL               17
#define MIC2R_2_RADC_CTRL               18
...
#endif
	SOC_ENUM_SINGLE(MIC2L_2_LADC_CTRL, 7, 2, aic3x_linein_mode_mux),
	SOC_ENUM_SINGLE(MIC2R_2_RADC_CTRL, 7, 2, aic3x_linein_mode_mux),
...
static const struct snd_kcontrol_new aic3x_snd_controls[] = {
...
#endif
        SOC_SINGLE_TLV("Left Mic Mixer Mic2R Bypass Volume",
                       LINE2R_2_LLOPM_VOL, 0, 118, 1, output_stage_tlv),
...
#endif
        SOC_SINGLE_TLV("Right Mic Mixer Mic2L Bypass Volume",
                       LINE2L_2_RLOPM_VOL, 0, 118, 1, output_stage_tlv),
...
#endif
        SOC_SINGLE_TLV("Left HP Mixer Mic2R Bypass Volume",
                       LINE2R_2_HPLOUT_VOL, 0, 118, 1, output_stage_tlv),
...
#endif
        SOC_SINGLE_TLV("Right HP Mixer Mic2L Bypass Volume",
                       LINE2L_2_HPROUT_VOL, 0, 118, 1, output_stage_tlv),
...
#endif
	SOC_SINGLE_TLV("Left HPCOM Mixer Mic2R Bypass Volume",
		       LINE2R_2_HPLCOM_VOL, 0, 118, 1, output_stage_tlv),
...
#endif
	SOC_SINGLE_TLV("Right HPCOM Mixer Mic2L Bypass Volume",
		       LINE2L_2_HPRCOM_VOL, 0, 118, 1, output_stage_tlv),
...
#endif
        SOC_DOUBLE_R_TLV("Mic Mic2 Bypass Volume",
                         LINE2L_2_LLOPM_VOL, LINE2R_2_RLOPM_VOL,
                         0, 118, 1, output_stage_tlv),
	...
	SOC_DOUBLE_R_TLV("Mono Line2 Bypass Volume",
			 ...
			 0, 118, 1, output_stage_tlv),
#endif     
        SOC_DOUBLE_R_TLV("Mono Mic2 Bypass Volume",
                         LINE2L_2_MONOLOPM_VOL, LINE2R_2_MONOLOPM_VOL,
                         0, 118, 1, output_stage_tlv),
	...
	SOC_DOUBLE_R_TLV("HP Line2 Bypass Volume",
			 ...
			 0, 118, 1, output_stage_tlv),
#endif
        SOC_DOUBLE_R_TLV("HP Mic2 Bypass Volume",
                         LINE2L_2_HPLOUT_VOL, LINE2R_2_HPROUT_VOL,
                         0, 118, 1, output_stage_tlv),
	...
	SOC_DOUBLE_R_TLV("HPCOM Line2 Bypass Volume",
			 ...
			 0, 118, 1, output_stage_tlv),
#endif
        SOC_DOUBLE_R_TLV("HPCOM Mic2 Bypass Volume",
                         LINE2L_2_HPLCOM_VOL, LINE2R_2_HPRCOM_VOL,
                         0, 118, 1, output_stage_tlv),
...
#endif
	SOC_DAPM_SINGLE("Mic2L Bypass Switch", LINE2L_2_LLOPM_VOL, 7, 1, 0),
	SOC_DAPM_SINGLE("PGAL Bypass Switch", PGAL_2_LLOPM_VOL, 7, 1, 0),
	SOC_DAPM_SINGLE("DACL1 Switch", DACL1_2_LLOPM_VOL, 7, 1, 0),
#if 0
	SOC_DAPM_SINGLE("Line2R Bypass Switch", LINE2R_2_LLOPM_VOL, 7, 1, 0),
#endif
	SOC_DAPM_SINGLE("Mic2R Bypass Switch", LINE2R_2_LLOPM_VOL, 7, 1, 0),
...
#endif
	SOC_DAPM_SINGLE("Mic2L Bypass Switch", LINE2L_2_RLOPM_VOL, 7, 1, 0),
	SOC_DAPM_SINGLE("PGAL Bypass Switch", PGAL_2_RLOPM_VOL, 7, 1, 0),
	SOC_DAPM_SINGLE("DACL1 Switch", DACL1_2_RLOPM_VOL, 7, 1, 0),
#if 0
	SOC_DAPM_SINGLE("Line2R Bypass Switch", LINE2R_2_RLOPM_VOL, 7, 1, 0),
#endif
	SOC_DAPM_SINGLE("Mic2R Bypass Switch", LINE2R_2_RLOPM_VOL, 7, 1, 0),
...
#endif
	SOC_DAPM_SINGLE("Mic2L Bypass Switch", LINE2L_2_MONOLOPM_VOL, 7, 1, 0),
...
#endif
	SOC_DAPM_SINGLE("Mic2R Bypass Switch", LINE2R_2_MONOLOPM_VOL, 7, 1, 0),
...
#endif
	SOC_DAPM_SINGLE("Mic2L Bypass Switch", LINE2L_2_HPLOUT_VOL, 7, 1, 0),
	SOC_DAPM_SINGLE("PGAL Bypass Switch", PGAL_2_HPLOUT_VOL, 7, 1, 0),
	SOC_DAPM_SINGLE("DACL1 Switch", DACL1_2_HPLOUT_VOL, 7, 1, 0),
#if 0
	SOC_DAPM_SINGLE("Line2R Bypass Switch", LINE2R_2_HPLOUT_VOL, 7, 1, 0),
#endif
	SOC_DAPM_SINGLE("Mic2R Bypass Switch", LINE2R_2_HPLOUT_VOL, 7, 1, 0),
...
#endif
	SOC_DAPM_SINGLE("Mic2L Bypass Switch", LINE2L_2_HPROUT_VOL, 7, 1, 0),
	SOC_DAPM_SINGLE("PGAL Bypass Switch", PGAL_2_HPROUT_VOL, 7, 1, 0),
	SOC_DAPM_SINGLE("DACL1 Switch", DACL1_2_HPROUT_VOL, 7, 1, 0),
#if 0
	SOC_DAPM_SINGLE("Line2R Bypass Switch", LINE2R_2_HPROUT_VOL, 7, 1, 0),
#endif
	SOC_DAPM_SINGLE("Mic2R Bypass Switch", LINE2R_2_HPROUT_VOL, 7, 1, 0),
...
#endif
	SOC_DAPM_SINGLE("Mic2L Bypass Switch", LINE2L_2_HPLCOM_VOL, 7, 1, 0),
	SOC_DAPM_SINGLE("PGAL Bypass Switch", PGAL_2_HPLCOM_VOL, 7, 1, 0),
	SOC_DAPM_SINGLE("DACL1 Switch", DACL1_2_HPLCOM_VOL, 7, 1, 0),
#if 0
	SOC_DAPM_SINGLE("Line2R Bypass Switch", LINE2R_2_HPLCOM_VOL, 7, 1, 0),
#endif
	SOC_DAPM_SINGLE("Mic2R Bypass Switch", LINE2R_2_HPLCOM_VOL, 7, 1, 0),
...
#endif
	SOC_DAPM_SINGLE("Mic2L Bypass Switch", LINE2L_2_HPRCOM_VOL, 7, 1, 0),
	SOC_DAPM_SINGLE("PGAL Bypass Switch", PGAL_2_HPRCOM_VOL, 7, 1, 0),
	SOC_DAPM_SINGLE("DACL1 Switch", DACL1_2_HPRCOM_VOL, 7, 1, 0),
#if 0
	SOC_DAPM_SINGLE("Line2R Bypass Switch", LINE2R_2_HPRCOM_VOL, 7, 1, 0),
#endif
	SOC_DAPM_SINGLE("Mic2R Bypass Switch", LINE2R_2_HPRCOM_VOL, 7, 1, 0),
...
#endif
        SOC_DAPM_SINGLE_AIC3X("Mic2L Switch", MIC2LR_2_LADC_CTRL, 4, 1, 1),
        SOC_DAPM_SINGLE_AIC3X("Mic2R Switch", MIC2LR_2_LADC_CTRL, 0, 1, 1),
};
...
#endif
        SOC_DAPM_SINGLE_AIC3X("Mic2L Switch", MIC2LR_2_RADC_CTRL, 4, 1, 1),
        SOC_DAPM_SINGLE_AIC3X("Mic2R Switch", MIC2LR_2_RADC_CTRL, 0, 1, 1),
};
...
#endif
	SND_SOC_DAPM_MUX("Left Mic2L Mux", SND_SOC_NOPM, 0, 0,
			 &aic3x_left_line2_mux_controls),
...
#endif
	SND_SOC_DAPM_MUX("Right Mic2R Mux", SND_SOC_NOPM, 0, 0,
			 &aic3x_right_line2_mux_controls),
...
#endif
        {"Left Mic2L Mux", "single-ended", "MIC2L"},
        {"Left Mic2L Mux", "differential", "MIC2L"},
...
#endif
#if 0
	{"Left PGA Mixer", "Mic2L Switch", "Left Mic2L Mux"},
#endif
#if 0
...
#endif
	{"Right Mic2R Mux", "single-ended", "MIC2R"},
	{"Right Mic2R Mux", "differential", "MIC2R"},
...
#endif
#if 0
	{"Right PGA Mixer", "Mic2R Switch", "Right Line2R Mux"},
#endif
#if 0
...
#endif
#if 0
	{"Left Mic Mixer", "Mic2L Bypass Switch", "Left Mic2L Mux"},
#endif
...
#endif
#if 0
	{"Left Mic Mixer", "Mic2R Bypass Switch", "Right Mic2R Mux"},
#endif
...
#endif
	{"Right Line Mixer", "Mic2L Bypass Switch", "Left Mic2L Mux"},
...
#endif
	{"Right Line Mixer", "Mic2R Bypass Switch", "Right Mic2R Mux"},
...
#endif
	{"Left HP Mixer", "Mic2L Bypass Switch", "Left Mic2L Mux"},
	{"Left HP Mixer", "PGAL Bypass Switch", "Left PGA Mixer"},
	{"Left HP Mixer", "DACL1 Switch", "Left DAC Mux"},
#if 0
	{"Left HP Mixer", "Line2R Bypass Switch", "Right Line2R Mux"},
#endif
	{"Left HP Mixer", "Mic2R Bypass Switch", "Right Mic2R Mux"},
...
#endif
	{"Right HP Mixer", "Mic2L Bypass Switch", "Left Mic2L Mux"},
	{"Right HP Mixer", "PGAL Bypass Switch", "Left PGA Mixer"},
	{"Right HP Mixer", "DACL1 Switch", "Left DAC Mux"},
#if 0
	{"Right HP Mixer", "Line2R Bypass Switch", "Right Line2R Mux"},
#endif
	{"Right HP Mixer", "Mic2R Bypass Switch", "Right Mic2R Mux"},
...
#endif
	{"Left HPCOM Mixer", "Mic2L Bypass Switch", "Left Mic2L Mux"},
	{"Left HPCOM Mixer", "PGAL Bypass Switch", "Left PGA Mixer"},
	{"Left HPCOM Mixer", "DACL1 Switch", "Left DAC Mux"},
#if 0
	{"Left HPCOM Mixer", "Line2R Bypass Switch", "Right Line2R Mux"},
#endif
	{"Left HPCOM Mixer", "Mic2R Bypass Switch", "Right Mic2R Mux"},
...
#endif
	{"Right HPCOM Mixer", "Mic2L Bypass Switch", "Left Mic2L Mux"},
	{"Right HPCOM Mixer", "PGAL Bypass Switch", "Left PGA Mixer"},
	{"Right HPCOM Mixer", "DACL1 Switch", "Left DAC Mux"},
#if 0
	{"Right HPCOM Mixer", "Line2R Bypass Switch", "Right Line2R Mux"},
#endif
	{"Right HPCOM Mixer", "Mic2R Bypass Switch", "Right Mic2R Mux"},
