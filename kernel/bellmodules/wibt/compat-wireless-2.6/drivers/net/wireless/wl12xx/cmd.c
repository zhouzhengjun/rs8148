...
{
	struct wl1271_cmd_config_fw_logger *cmd;
	int ret = 0;
	...
	cmd->logger_mode = logger_mode;
	cmd->log_severity = log_severity;
...
{
	struct wl1271_cmd_start_fw_logger *cmd;
	int ret = 0;
...
{
	struct wl1271_cmd_stop_fw_logger *cmd;
	int ret = 0;
