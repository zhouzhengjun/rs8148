...
int wl1271_cmd_config_fw_logger(struct wl1271 *wl, u8 logger_mode,
			u8 log_severity, u8 timestamp, u8 output, u8 threshold);
int wl1271_cmd_start_fw_logger(struct wl1271 *wl);
int wl1271_cmd_stop_fw_logger(struct wl1271 *wl);
 ...
 */
enum wl1271_fwlogger_log_mode {
	FWLOGGER_CONTINUOUS,
	FWLOGGER_ON_DEMAND
};

/* Include/exclude timestamps from the log messages */
enum wl1271_fwlogger_timestamp {
	FWLOGGER_TIMESTAMP_DISABLED,
	FWLOGGER_TIMESTAMP_ENABLED
};
 ...
 * (SDIO/SPI), or dropped
 */
enum wl1271_fwlogger_output {
	FWLOGGER_OUTPUT_NONE,
	FWLOGGER_OUTPUT_DBG_PINS,
	FWLOGGER_OUTPUT_HOST,
};

struct wl1271_cmd_config_fw_logger {
	struct wl1271_cmd_header header;

	/* See enum wl1271_fwlogger_log_mode */
	u8 logger_mode;
...
struct wl1271_cmd_start_fw_logger {
	struct wl1271_cmd_header header;
} __packed;

struct wl1271_cmd_stop_fw_logger {
	struct wl1271_cmd_header header;
} __packed;
