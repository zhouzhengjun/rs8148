...
static int wl1271_init_fw_logger(struct wl1271 *wl)
{
	int ret;

	ret = wl1271_cmd_config_fw_logger(wl, FWLOGGER_ON_DEMAND, 0,
		FWLOGGER_TIMESTAMP_DISABLED, FWLOGGER_OUTPUT_HOST, 5);
	if (ret < 0)
		return ret;
